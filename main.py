...
app = FastAPI(
    ...
    description="""Routes user input to Knowledge or Customer Agent using LangChain, LangGraph, OpenAI 
                    ...
                    integer from 1 to 100. For Knowledge Agent, try asking "What payment methods are supported?" or "How does Pix work?". For Customer Agent, try asking "What are the total number of transactions in my account?" or "I want the names of all merchants in my account".
                """, 
    version="1.0"
    )
